...
class ConsentCenterScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsentCenterScreen> createState() => _ConsentCenterScreenState();
}

class _ConsentCenterScreenState extends ConsumerState<ConsentCenterScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            _ConsentCenterHeader(onBack: () => context.pop()),
    ...
    switch (state.status) {
      ...
      case ConsentLoadStatus.error:
        return _ConsentError(
          message: state.errorMessage ?? 'Unable to load your consent information.',
...
class _ConsentCenterHeader extends StatelessWidget {
  final VoidCallback onBack;
  const _ConsentCenterHeader({required this.onBack});
